...
func (q migrationQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Migration, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "sqlboilermodel: failed to execute a one query for migration")
	}
...
func (q migrationQuery) All(ctx context.Context, exec boil.ContextExecutor) (MigrationSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "sqlboilermodel: failed to assign all query results to Migration slice")
	}
...
func (q migrationQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboilermodel: failed to count migration rows")
	}
...
func (q migrationQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "sqlboilermodel: failed to check if migration exists")
	}
...
func FindMigration(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Migration, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "sqlboilermodel: unable to select from migration")
	}
...
func (o *Migration) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("sqlboilermodel: no migration provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "sqlboilermodel: unable to insert into migration")
	}
...
func (o *Migration) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("sqlboilermodel: unable to update migration, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboilermodel: unable to update migration row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboilermodel: failed to get rows affected by update for migration")
	}
...
func (q migrationQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboilermodel: unable to update all for migration")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboilermodel: unable to retrieve rows affected for migration")
	}
...
func (o MigrationSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboilermodel: unable to update all in migration slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboilermodel: unable to retrieve rows affected all in update all migration")
	}
	return rowsAff, nil
}
...
func (o *Migration) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("sqlboilermodel: no migration provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("sqlboilermodel: unable to upsert migration, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "sqlboilermodel: unable to upsert migration")
	}
...
func (o *Migration) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("sqlboilermodel: no Migration provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "sqlboilermodel: unable to delete from migration")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboilermodel: failed to get rows affected by delete for migration")
	}
...
func (q migrationQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("sqlboilermodel: no migrationQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "sqlboilermodel: unable to delete all from migration")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboilermodel: failed to get rows affected by deleteall for migration")
	}
...
func (o MigrationSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "sqlboilermodel: unable to delete all from migration slice")
	}
...
func (o *MigrationSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "sqlboilermodel: unable to reload all in MigrationSlice")
	}
...
func MigrationExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "sqlboilermodel: unable to check if migration exists")
	}
