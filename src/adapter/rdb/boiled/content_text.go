...
func (q contentTextQuery) One(ctx context.Context, exec boil.ContextExecutor) (*ContentText, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boiled: failed to execute a one query for content_text")
	}
...
func (q contentTextQuery) All(ctx context.Context, exec boil.ContextExecutor) (ContentTextSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "boiled: failed to assign all query results to ContentText slice")
	}
...
func (q contentTextQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiled: failed to count content_text rows")
	}
...
func (q contentTextQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "boiled: failed to check if content_text exists")
	}
...
func FindContentText(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*ContentText, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boiled: unable to select from content_text")
	}
...
func (o *ContentText) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("boiled: no content_text provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "boiled: unable to insert into content_text")
	}
...
func (o *ContentText) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("boiled: unable to update content_text, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiled: unable to update content_text row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiled: failed to get rows affected by update for content_text")
	}
...
func (q contentTextQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiled: unable to update all for content_text")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiled: unable to retrieve rows affected for content_text")
	}
...
func (o ContentTextSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiled: unable to update all in contentText slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiled: unable to retrieve rows affected all in update all contentText")
	}
	return rowsAff, nil
}
...
func (o *ContentText) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("boiled: no content_text provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("boiled: unable to upsert content_text, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "boiled: unable to upsert content_text")
	}
...
func (o *ContentText) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("boiled: no ContentText provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boiled: unable to delete from content_text")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiled: failed to get rows affected by delete for content_text")
	}
...
func (q contentTextQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("boiled: no contentTextQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "boiled: unable to delete all from content_text")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiled: failed to get rows affected by deleteall for content_text")
	}
...
func (o ContentTextSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boiled: unable to delete all from contentText slice")
	}
...
func (o *ContentTextSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "boiled: unable to reload all in ContentTextSlice")
	}
...
func ContentTextExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "boiled: unable to check if content_text exists")
	}
