...
func (q contentImageQuery) One(ctx context.Context, exec boil.ContextExecutor) (*ContentImage, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boiled: failed to execute a one query for content_image")
	}
...
func (q contentImageQuery) All(ctx context.Context, exec boil.ContextExecutor) (ContentImageSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "boiled: failed to assign all query results to ContentImage slice")
	}
...
func (q contentImageQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiled: failed to count content_image rows")
	}
...
func (q contentImageQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "boiled: failed to check if content_image exists")
	}
...
func FindContentImage(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*ContentImage, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boiled: unable to select from content_image")
	}
...
func (o *ContentImage) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("boiled: no content_image provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "boiled: unable to insert into content_image")
	}
...
func (o *ContentImage) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("boiled: unable to update content_image, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiled: unable to update content_image row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiled: failed to get rows affected by update for content_image")
	}
...
func (q contentImageQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiled: unable to update all for content_image")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiled: unable to retrieve rows affected for content_image")
	}
...
func (o ContentImageSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiled: unable to update all in contentImage slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiled: unable to retrieve rows affected all in update all contentImage")
	}
	return rowsAff, nil
}
...
func (o *ContentImage) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("boiled: no content_image provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("boiled: unable to upsert content_image, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "boiled: unable to upsert content_image")
	}
...
func (o *ContentImage) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("boiled: no ContentImage provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boiled: unable to delete from content_image")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiled: failed to get rows affected by delete for content_image")
	}
...
func (q contentImageQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("boiled: no contentImageQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "boiled: unable to delete all from content_image")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiled: failed to get rows affected by deleteall for content_image")
	}
...
func (o ContentImageSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boiled: unable to delete all from contentImage slice")
	}
...
func (o *ContentImageSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "boiled: unable to reload all in ContentImageSlice")
	}
...
func ContentImageExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "boiled: unable to check if content_image exists")
	}
